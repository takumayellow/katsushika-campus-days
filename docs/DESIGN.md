...
**棟ごとの中身**（実測 2026-09-24・合計 296,065 三角形 / 上限 300,000）:
...
| `lab1` | 22,502 | 廊下（ロッカー・掲示板・自販機）+ 実験室 2 室 + 準備室 1 室（実験台・ドラフト・ボンベ・薬品庫・試薬棚・流し） |
| `lab2` | 12,980 | 短辺（東面）の入口から玄関ホール + 廊下 + 実験室 1 室 + 準備室 1 室（同上） |
| `greenhouse` | 4,072 | 切妻ガラス屋根・栽培ベンチ 4 列・鉢植え・灌水パイプ |
