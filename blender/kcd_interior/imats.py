...
PALETTE = {
    ...
    # ---- 寮（葛飾コミュニティハウス 1F。館内写真から） ----
    "wallpaper_orange":   ((0.552, 0.122, 0.050), 0.85, 0.0, 1.0),
    "fabric_yellow":      ((0.768, 0.509, 0.027), 0.86, 0.0, 1.0),
    "floor_carpet_gold":  ((0.434, 0.275, 0.076), 0.95, 0.0, 1.0),
    "door_frosted":       ((0.723, 0.776, 0.791), 0.30, 0.0, 1.0),
}
