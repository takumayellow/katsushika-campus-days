...
合計 **297,441 三角形**（上限 300,000）。窓の外の近景は別に数えて **166,260 三角形**（上限 180,000、
...
| `research2` | 第2研究棟 | 64,210 | 25,385 | 1.11 MB | 36 | 1〜2F 吹き抜けの**大食堂 1,400 席**（配膳カウンター 38 m・券売機 6 台・返却口・2F 回廊 240 席） |
...
| `lab2` | 実験棟2 | 14,300 | 6,496 | 0.33 MB | 10 | 廊下 + 実験室 1 室 + 準備室 1 室（同上） |
| `greenhouse` | 温室 | 4,128 | 4,109 | 0.19 MB | 5 | 切妻ガラス屋根・栽培ベンチ 2 列・鉢植え・灌水パイプ |
